...
[Table("L_PemeriksaanPenunjang")]
public partial class L_PemeriksaanPenunjang
{
   [Key]
    ...
    public virtual ICollection<L_PemeriksaanPenunjangDetail> L_PemeriksaanPenunjangDetails { get; set; } = new List<L_PemeriksaanPenunjangDetail>();
}